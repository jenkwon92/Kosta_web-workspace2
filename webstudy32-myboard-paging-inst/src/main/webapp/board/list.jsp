...
<ul class="pagination justify-content-center" style="margin: 20px 0">
	<%--requestScope 생략가능 requestScope.pagingBean.previousPageGroup--%>
	<c:if test="${pagingBean.previousPageGroup }">
		<li class="page-item"><a class="page-link"
			href="ListController.do?pageNo=${pagingBean.startPageOfPageGroup-1 }">Previous</a></li>
	</c:if>
	...
	<c:if test="${pagingBean.nextPageGroup }">
		<li class="page-item"><a class="page-link"
			href="ListController.do?pageNo=${pagingBean.endPageOfPageGroup+1 }">Next</a></li>
	</c:if>
</ul>
